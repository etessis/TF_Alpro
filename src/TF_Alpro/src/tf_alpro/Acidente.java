...
public class Acidente {
    ...
    public Acidente(String rua, String ruatipo, String ruanome, String tipo, Date dataHora, String diaSemana, int feridos, int mortes, int mortesPos, int fatais, int auto, int taxi, int lotacao, int onibusUrb, int onibusInt, int caminhao, int moto, int carroca, int bicicleta, String tempo, String noiteDia, String regiao) {
        this.rua = rua;
        this.ruatipo = ruatipo;
